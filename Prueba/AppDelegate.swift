...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    private func launchScreen(){
        ...
        Timer.scheduledTimer(timeInterval: 6, target: self, selector: #selector(dismissLaunchController), userInfo: nil, repeats: false)
    }
    
    @objc func dismissLaunchController(){
        ...
        //let rootVC = mainVC.instantiateViewController(withIdentifier: "grafo")
        self.window?.rootViewController = rootVC
        self.window?.makeKeyAndVisible()
    }
